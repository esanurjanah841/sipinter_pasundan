                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div style="font-size: 14px;">
                            ...
                            <a href="" data-toggle="modal" data-target="#periode" target="_BLANK" class="btn btn-success btn-icon-split" style="font-size 14px; margin: 7px;">
                                <span class="icon text-white-50">
                                    <i class="fas fa-print"></i>
                                </span>
                                <span class="text">Excel</span>
                            </a>
                            <a href="LaporanSRQ.php" target="_BLANK" class="btn btn-info btn-icon-split" style="font-size 14px; margin: 7px;">
                                <span class="icon text-white-50">
                                    <i class="fas fa-print"></i>
                                </span>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Pilih periode pemeriksaan</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <br>
                                <div>
                                    <Label for="tgl_a">Periode Akhir</Label>
