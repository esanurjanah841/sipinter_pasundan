...
<section id="Menupasien" class="services" style="margin-top: 50px;">
  ...
  <div style="position:fixed;left:20px;bottom:20px; z-index: 1000 !important;">
    ...
    <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
        <a>
          <img src="gambar/ISH/1.png" class="card-img-top" alt="...">
          </a>
      </div>
      <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
        <a>
          <img src="gambar/ISH/2.png" class="card-img-top" alt="...">
          </a>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
        <a>
          <img src="gambar/ISH/3.jpg" class="card-img-top" alt="...">
          </a>
      </div>
      <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
        <a>
          <img src="gambar/ISH/4.png" class="card-img-top" alt="...">
          </a>
      </div>
    </div>
    ...
    <div class="col-md-6 col-lg-6 d-flex align-items-stretch mb-5 mb-lg-0">
        <a>
          <img src="gambar/ISH/5.png" class="card-img-top" alt="...">
          </a>
      </div>
    </div>
