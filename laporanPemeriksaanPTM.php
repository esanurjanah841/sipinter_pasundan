...
?>
        ...
        <div class="card shadow mb-4">
            ...
            <div style="font-size: 14px;">
                <a data-toggle="modal" data-target="#periode" target="_BLANK" class="btn btn-success btn-icon-split" style="font-size 14px; margin: 7px;">
                ...
                <div class="modal fade" id="periode" tabdashboard="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="laporanPTMExcel.php" method="POST">
