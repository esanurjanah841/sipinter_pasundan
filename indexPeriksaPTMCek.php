                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form action="function.php?act=tambahPTMHasil" id="tambah" method="POST">
                                ...
                                <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control-tes col-lg-12" id="tinggi" name="tinggi" value="<?= $tinggi ?>" readonly><?php echo "&emsp;cm" ?>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="berat">Berat Badan</label><br>
                                        <input type="text" class="form-control-tes col-lg-12" id="berat" name="berat" value="<?= $berat ?>" readonly> <?php echo "&emsp;kg" ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control-tes col-lg-8" id="sistol" name="sistol" value="<?= $sistol ?>" readonly><?php echo "&emsp;mmHg (<140/90)" ?>
                                    </div>
                                    
                                    <div class="form-group col-lg-6">
                                        <label for="diastol">Tekanan Darah Diastol</label><br>
                                        <input type="text" class="form-control-tes col-lg-8" id="diastol" name="diastol" value="<?= $diastol ?>" readonly><?php echo "&emsp;mmHg (<140/90)" ?>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control-tes col-lg-12" id="lingkar" name="lingkar" value="<?= $lingkar ?>" readonly><?php echo "&emsp;cm" ?>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="periksa_gula">Pemeriksaan Gula Darah Sewaktu</label>
                                        <input type="text" class="form-control-tes col-lg-9" id="periksa_gula" name="periksa_gula" value="<?= $periksa_gula ?>" readonly><?php echo "&emsp;mg/dl (<200)" ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="checkbox" id="h_normal" name="h_normal"  value="Normal">
                                    <label for="h_normal">Normal</label><br>
                                </div>
                                <div class="form-group ">
                                    <label for="feedback">Rekomendasi Dokter</label>
                                    <textarea class="form-control form-control-user" id="feedback" name="feedback"></textarea>
                                </div>
